...
def recommend_words(sentence, es):
    ...
    # 연관 단어 추출 (입력된 토큰 제외)
    related_words = extract_related_words(news_hits, excluded_tokens=set(tokens+["대사", "지원", "감독", "현장", "경기", "최고", "인사", "전국", "시작", "올해", "추진", "투자", "연속", "시장", "세계", "지역", "최대", "국민", "테크", "어닝", "실적", "서학", "시즌", "지난해", "논의", "언론", "공화", "개정", "지지", "끝내", "경선", "집권", "초반", "대세", "개표", "구독", "상조", "라이프", "산업", "에듀", "케이", "학교", "송치", "트럭", "관계자", "전문", "일요일", "목요일", "월요일", "토요일", "화요일", "수요일", "금요일", "잡기", "실률", "사촌", "마을"]))
